  ...
  return (
    <div className='flex'>
      ...
      <div className='w-[78%] h-[100vh] overflow-y-auto pt-[32px] pl-[71px] border-l-[1px] border-[#D3D3D3] pr-[81px]'>
        ...
        <h1 className='font-semibold text-[32px] leading-[38.73px] mb-[43px]'>To’lov</h1>
              ...
              <>
                <ul className='flex flex-col'>
                  ...
                  <li className='w-[417px] pb-[5px] border-b-[2px] flex items-center justify-between mb-[14px]'>
                    <h3 className='font-medium text-[17.96px] leading-[21.74px] text-[#202020]'>Dokument Narxi</h3>
                    <p className='font-medium text-[17.96px] leading-[21.74px] text-[#202020]'>300 000 so'm</p>
                  </li>
                  <li className='w-[417px] pb-[5px] border-b-[2px] flex items-center justify-between'>
                    <h3 className='font-medium text-[17.96px] leading-[21.74px] text-[#202020]'>Chegirma</h3>
                    <p className='font-medium text-[17.96px] leading-[21.74px] text-[#202020]'>0 so’m</p>
                  </li>
                  <li className='w-[417px] flex items-center justify-between mt-[17px]'>
                    <h3 className='font-medium text-[23.95px] leading-[28.98px] text-[#1E90FFBF]'>Jami</h3>
                    <p className='font-medium text-[23.95px] leading-[28.98px] text-[#1E90FFBF]'>300 000 so'm</p>
                  </li>
                </ul>
          ...
          <div>
            ...
            <form id="payment-form" onSubmit={handlePaymentClick} className='mt-[56px]' autoComplete='off'>
              <label className='w-[385px] flex flex-col gap-[15px] rounded-[8px] mb-[21px]'>
                <p className='font-medium text-[14px] leading-[16.94px] text-[#202020]'>Karta raqamini kiriting</p>
                <input onChange={handleCardNumDChange} maxLength={19} minLength={19} required value={inputCardNum || ''} className='w-full py-[15px]  minlength="16"  px-[8px] outline-none border-[2px] border-[#DCDCDC] rounded-[8px] focus:border-[#1E90FFCC] font-regular text-[14px] leading-[16.94px] placeholder:text-[#898989] text-black' type="text" placeholder='karta raqamini kiriting' aria-label='CardNumber' />
              </label>
              <label className='w-[385px] flex flex-col gap-[15px] rounded-[8px] mb-[21px]'>
                <p className='font-medium text-[14px] leading-[16.94px] text-[#202020]'>Karta amal qilish muddati</p>
                <input onChange={handleInputChange} maxLength="5" value={inputValue || ''} required className='w-full py-[15px]  minlength="16"  px-[8px] outline-none border-[2px] border-[#DCDCDC] rounded-[8px] focus:border-[#1E90FFCC] font-regular text-[14px] leading-[16.94px] placeholder:text-[#898989] text-black' type="text" placeholder='12/32' aria-label='CardData' />
              </label>
              <label className='w-[385px] flex flex-col gap-[15px] rounded-[8px] mb-[21px]'>
                <p className='font-medium text-[14px] leading-[16.94px] text-[#202020]'>bog’lanish uchun raqam kiriting</p>
                <div className='w-full py-[15px] pl-[15px] pr-[5px] border-[2px] border-[#DCDCDC] rounded-[8px] focus:border-[#1E90FFCC] font-regular text-[14px] leading-[16.94px] placeholder:text-[#898989] text-black flex'>
                  ...
                  <input onChange={handlePhoneCHange} value={phone} className='outline-none ml-2' maxLength="13" required type="tel" placeholder='+998902313871' aria-label='ContactNumber' />
                </div>
              </label>
            </form>
          </div>
        </div>
        <button type='submit' form="payment-form" className='w-[252px] hover:scale-[1.1] duration-300 block mx-auto mt-[55px] py-[24px] px-[70px] bg-[#1E90FFCC] text-[#F5F5F5] rounded-[15px] font-semibold text-[20px] leading-[24px] mb-[176px]'>To’lov qilish</button>
      </div>
    </div>
  )
}
